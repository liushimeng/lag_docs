# 虚拟城市 · P1 扩展：明斯基金融不稳定引擎 + LPR 重定价与提前还款

> **版本**：v1 ｜ **日期**：2026-09-16 ｜ **game_kind**: `wealth`
> 本文件是 P1 阶段的**实现契约**——明斯基三阶段融资/时刻 + LPR 年度重定价/提前还款决策。
> 上游设计来源：《虚拟城市设计优化与机制增补_v2.60》§4.4(N11-4)/§4.5(N11-5)/§5.3(N12-3)/§5.5(N12-5)。
...
虚拟城市要「完全模拟真实世界的财富流动」。P0 已实现央行货币传导、四周期市场、信贷约束。P1 本次新增**两项真实金融机制**：
