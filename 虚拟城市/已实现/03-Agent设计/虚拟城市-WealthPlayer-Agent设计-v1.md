...
> 引擎侧 ToolRunner 实现见 [`../02-架构设计/虚拟城市-后端架构与经济引擎-v1.md`](../02-架构设计/虚拟城市-后端架构与经济引擎-v1.md) §15；
...
```go
// AgentClassWealthPlayer 是虚拟城市玩家 Bot 的 AgentClassName（P0 v1）。
...
// 详见 docs/虚拟城市/已实现/03-Agent设计/虚拟城市-WealthPlayer-Agent设计-v1.md。
